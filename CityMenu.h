...
public:
	...
	enum CharacterItem
	{
		...
		// TODO: remake MessageBox for Inspect button into custom window
		//CHARACTER_INSPECT,
		//CHARACTER_STAT_INSPECT_TYPE,
		//CHARACTER_STAT_INSPECT_DAMAGE,
		//CHARACTER_STAT_INSPECT_STRENGTH_SCALE,
		//CHARACTER_STAT_INSPECT_DEXTERITY_SCALE,
		//CHARACTER_STAT_INSPECT_SHIELD_DEFENSE,
		//CHARACTER_STAT_INSPECT_SHIELD_BLOCK_CHANCE,
		//CHARACTER_STAT_INSPECT_ARMOUR_DEFENSE,
		//CHARACTER_STAT_INSPECT_ARMOUR_ABILITY,
		//CHARACTER_STAT_INSPECT_VALUE,
		//CHARACTER_STAT_INSPECT_QUANTITY,
		//CHARACTER_STAT_INSPECT_TOTAL_VALUE,
		//CHARACTER_BUT_INSPECT_ICON,
		//CHARACTER_BUT_INSPECT_CLOSE,
...
private:
	...
	void drawInventoryItem(HWND, LPDRAWITEMSTRUCT, int buttonIndex_);
